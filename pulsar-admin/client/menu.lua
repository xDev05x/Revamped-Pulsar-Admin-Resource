...
--     _menuOpen = true
--     exports["pulsar-core"]:ServerCallback('Admin:GetMenuData', {}, function(isAdmin, data)
...
--         if data then
--             adminSubMenus = {}
--             adminMenu = exports['pulsar-menu']:Create('adminMenu', 'Admin Menu', function(id, back)
--                 _menuOpen = true
--             end, function()
--                 _menuOpen = false
--                 Wait(100)
...
--                 adminSubMenus['activePlayers'] = exports['pulsar-menu']:Create('adminActivePlayers', 'Player Management')
...
--                         adminSubMenus[playerMenuId] = exports['pulsar-menu']:Create(playerMenuId, string.format('Viewing Player: [%s] %s', player.Source, player.Name))

--                         -- PUNISH MENU
--                         adminSubMenus[playerMenuId.. '-punish'] = exports['pulsar-menu']:Create('adminActivePlayersPunish-' .. player.Source, string.format('Punish Player: [%s] %s', player.Source, player.Name))
...
--                             exports["pulsar-core"]:ServerCallback('Admin:PlayerTeleportAction', {
--                                 action = 'GOTO',
--                                 target = player.Source,
--                             }, function(success)
--                                 if success then
--                                     exports["pulsar-hud"]:Notification('success', 'Successfully Teleported to '.. player.Name)
--                                 else
--                                     exports["pulsar-hud"]:Notification('error', 'Failed to Teleport to '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                             }, function(success)
--                                 if success then
--                                     exports["pulsar-hud"]:Notification('success', 'Successfully Brought '.. player.Name)
--                                 else
--                                     exports["pulsar-hud"]:Notification('error', 'Failed to Bring '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                                 AdminStopAttach()
--                             else
--                                 exports["pulsar-core"]:ServerCallback('Admin:AttachToPlayer', player.Source, function(targetCoords)
...
--                         if player.Character then
--                             adminSubMenus[playerMenuId.. '-phone-perms'] = exports['pulsar-menu']:Create('adminPhonePerms-' .. player.Source, 'Update Phone Permissions')
...
--                                         exports["pulsar-core"]:ServerCallback('Admin:UpdatePhonePerms', {
--                                             target = player.Source,
--                                             app = appKey,
--                                             perm = permKey,
...
--             adminSubMenus['recentDisconnects'] = exports['pulsar-menu']:Create('adminRecentDisconnects', 'Recent Disconnects')
...
--                         adminSubMenus[playerMenuId] = exports['pulsar-menu']:Create(playerMenuId, string.format('Disconnected Player: [%s] %s', player.Source, player.Name))
...
--             -- Teleportation
--             adminSubMenus['teleportationUtils'] = exports['pulsar-menu']:Create('adminTeleportUtils', 'Teleport')
--             if data.spawnLocations then
--                 local spawnLocations = exports['pulsar-menu']:Create('adminSpawnLocations', 'Spawn Locations')
...
--             adminSubMenus['developerUtilities'] = exports['pulsar-menu']:Create('adminDevUtils', 'Developer Utilities')
...
--                 adminSubMenus['vehicleUtilities'] = exports['pulsar-menu']:Create('adminVehUtils', 'Vehicle Utilities')
...
--                         exports["pulsar-hud"]:Notification('success', 'Repaired Vehicle')
--                     end
--                 end)
...
--                         exports["pulsar-hud"]:Notification('success', 'Repaired Vehicle Fully')
--                     end
--                 end)
