...
RegisterNUICallback('GetPlayerList', function(data, cb)
    if data and data.disconnected then
        exports["pulsar-core"]:ServerCallback('Admin:GetDisconnectedPlayerList', data, cb)
    else
        exports["pulsar-core"]:ServerCallback('Admin:GetPlayerList', data, cb)
    end
end)

RegisterNUICallback('GetPlayer', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:GetPlayer', data, cb)
end)
...
RegisterNUICallback('ActionPlayer', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:ActionPlayer', data, cb)
end)

RegisterNUICallback('KickPlayer', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:KickPlayer', data, cb)
end)

RegisterNUICallback('BanPlayer', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:BanPlayer', data, cb)
end)

RegisterNUICallback('GetVehicleList', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:GetVehicleList', data, cb)
end)

RegisterNUICallback('GetVehicle', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:GetVehicle', data, cb)
end)
...
RegisterNUICallback('ActionVehicle', function(data, cb)
    ...
    exports["pulsar-core"]:ServerCallback('Admin:VehicleAction', data, cb)
end)

RegisterNUICallback('GetAllPlayersByCharacter', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:GetAllPlayersByCharacter', data, cb)
end)

RegisterNUICallback('CurrentVehicleAction', function(data, cb)
    local insideVehicle = GetVehiclePedIsIn(LocalPlayer.state.ped, true)
    if insideVehicle and insideVehicle > 0 and DoesEntityExist(insideVehicle) then
        exports["pulsar-core"]:ServerCallback('Admin:CurrentVehicleAction', data, function(canDo)
            if canDo then
                ...
                elseif data.action == 'explode' then
                    exports["pulsar-core"]:NetworkExplodeVehicle(insideVehicle, 1, 0)
                    return cb({
                        success = true,
...
RegisterNUICallback('ToggleInvisible', function(data, cb)
    exports["pulsar-core"]:ServerCallback('Admin:ToggleInvisible', data, cb)
end)
